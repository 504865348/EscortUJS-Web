...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <form action="/Home/Cend/docend" method="post">
		<input type="button" onclick="javascript:history.back(-1);" value="&laquo;" class="back tcm" />
			<div class="center-block w11">
				...
				<div class="input-group mt10 w12"><textarea placeholder="您的寄件地址" rows="5" class="form-control" name="address"></textarea></div>
                <div class="input-group mt10 w12"><textarea placeholder="您的地址，请写好自己所在的区和楼栋，以便取件" rows="5" class="form-control" name="cender_address"></textarea></div>
