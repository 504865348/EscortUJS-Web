...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <form action="/Home/Cend/group_docend" method="post">
		<input type="button" onclick="javascript:history.back(-1);" value="&laquo;" class="back tcm" />
			<div class="center-block w11">
                <div class="input-group mt10 w12"><input type="hidden" class="form-control" name="gid" value="<?php echo ($gid); ?>"/></div>
                <div class="input-group mt10 w12"><input type="text" class="form-control" name="" disabled="disabled" value="申请人手机号码：<?php echo ($phone); ?>，申请单号：<?php echo ($gid); ?>"/></div>
				<div class="input-group mt10 w12"><input type="text" placeholder="真实姓名" class="form-control" name="realname" required /></div>
				<div class="input-group mt10 w12">
                <input type="text" placeholder="手机号" class="form-control" name="phone" required /></div>
                <div class="input-group mt10 w12">
                <div class="col-xs-6">
                ...
                <div class="input-group mt10 w12"><textarea placeholder="您的地址，请写好自己所在的区和楼栋，以便取件" rows="5" class="form-control" name="address"></textarea></div>
				<div class="input-group mt10 w12"><textarea placeholder="您的寄件地址" rows="5" class="form-control" name="toaddress"></textarea></div>
