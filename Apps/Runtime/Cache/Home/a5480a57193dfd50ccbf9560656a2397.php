...
<body>
  ...
  <div class="panel-heading">
    <h3 class="panel-title">组团代寄</h3>
  </div>
  <div class="panel-body">
    <?php echo (htmlspecialchars_decode($info["news_content"])); ?>
  </div>
</div>
	<p align="center"><a href="/Home/Cend/apply_group" class="btn btn-primary" role="button">下单</a> <a href="/Home/Cend/index" class="btn btn-default" role="button">返回首页</a></p>	 
