    ...
    <body>
        <form action="/User/Index/change_password" method="post">
			...
			<div class="center-block w11">
				<div class="input-group w12 mt20"><input type="password" placeholder="旧密码" name="old_password" class="form-control" required /></div>
				<div class="input-group w12 mt20"><input type="password" placeholder="新密码" name="new_password" class="form-control" required /></div>
				<div class="input-group w12 mt20"><input type="password" placeholder="重复新密码" name="repassword" class="form-control" required /></div>
				<div class="w12 mt20"><input type="submit" value="确认修改" class="btn tcw bcm center-block w10" /></div>
			</div>
        </form>
    </body>
</html>