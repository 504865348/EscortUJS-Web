	...
	<ul id="baseParameter" class="collapse in">
		...
		<li><a href="/Admin/News/index" target="_self">消息设置</a></li>
				...
				<div class="article col-md-10">
					...
					<tr>
						<th width=100>编号</th>
						<th width=600>快递公司</th>
						<th width=600>更改</th>
						<th width=150>状态</th> 
					</tr>
					<?php if(is_array($datalist)): $i = 0; $__LIST__ = $datalist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						<td><?php echo ($vo["expcompany_id"]); ?></td>
						<td><?php echo ($vo["expcompany_name"]); ?></td>
						<td><a href="/Admin/BaseParameter/expCompanyUpdate/eid/<?php echo ($vo["expcompany_id"]); ?>">更改</a></td>
						<td>
							<a href="/Admin/BaseParameter/expCompanyDel/sid/<?php echo ($vo["expcompany_id"]); ?>">
					...
					<a href="/Admin/BaseParameter/expCompanyAdd" class="btn bcm tcw w4 mt20">添加</a>
				</div>
			</div>
			<div class="foot">
