		...
		<li><a href="/Admin/News/index" target="_self">消息设置</a></li>
				...
				<div class="article col-md-10">
					...
					<tr>
						...
						<th width=500>服务内容</th>
						<th width=100>修改</th> 
						<th width=100>状态</th> 
					</tr>
					<?php if(is_array($datalist)): $i = 0; $__LIST__ = $datalist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						<td><?php echo ($vo["server_content"]); ?></td>
						<td><?php echo ($vo["server_text"]); ?></td>
						<td><a href="/Admin/BaseParameter/serverUpdate/sid/<?php echo ($vo["server_id"]); ?>">修改</a></td>
						<td><a href="/Admin/BaseParameter/serverStatus/sid/<?php echo ($vo["server_id"]); ?>">
					...
					<a href="/Admin/BaseParameter/serverAdd" class="btn bcm tcw w4 mt20">添加</a>
				</div>
			</div>
			<div class="foot">
