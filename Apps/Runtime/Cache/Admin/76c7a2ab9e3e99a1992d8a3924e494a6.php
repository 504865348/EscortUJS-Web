...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <form action="/Admin/BaseParameter/doAdd" method="post">
			<div class="head">
		...
		<li><a href="/Admin/BaseParameter/addressConfig" target="_self">地址配置</a></li>
				...
				<div class="article col-md-10">
						...
						<div class="w11 center-block">
							<div class="input-group mt10 w12"><input type="text" placeholder="快递公司" class="form-control" name="expCompany_name" required /></div>
