...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
      ...
      <link href="<?php echo (CSS_URL); ?>style.css" type="text/css" rel="stylesheet" />
        ...
        <title>添加具体快递信息</title>
    </head>
    <body>
        <form action="/Admin/BaseParameter/doAddressConfigAdd" method="post">
			<div class="head">
		...
		<li><a href="/Admin/News/index" target="_self">消息设置</a></li>
				...
				<div class="article col-md-10">
						<div class="w11 center-block"> 
							...
							<a href="/Admin/BaseParameter/schoolAreaAdd" class="btn">如果没有想要的区域，点击这里添加区域</a>
							</div>
							<div class="input-group mt10 w6 mb20 center-block"><input type="text" placeholder="具体楼栋" class="form-control" name="school_area_detail_name" required /></div>
							<div class="input-group mt10 w6 mb20 center-block"><input type="submit" value="添加" class="btn w12 bcm tcw mt10" /></div>
						</div>
				</div>
			</div>
			<div class="foot">
