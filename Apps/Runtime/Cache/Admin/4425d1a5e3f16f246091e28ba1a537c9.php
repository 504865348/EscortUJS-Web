...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <form action="/Admin/BaseParameter/doServerAdd" method="post">
			<div class="head">
		...
		<li><a href="/Admin/BaseParameter/addressConfig" target="_self">地址配置</a></li>
				...
				<div class="article col-md-10">
						...
						<div class="w11 center-block"> 
							<div class="input-group mt10 w12"><input type="text" placeholder="服务类型" class="form-control" name="server_content" required /></div>
