...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <form action="/Admin/BaseParameter/doUpdate" method="post">
			<div class="head">
		...
		<li><a href="/Admin/BaseParameter/addressConfig" target="_self">地址配置</a></li>
				...
				<div class="article col-md-10">
						...
						<div class="w11 center-block"> 
							<div class="input-group mt10 w12"><input type="hidden" name="server_id" value="<?php echo ($datainfo["server_id"]); ?>" /></div>
							<div class="input-group mt10 w12"><input type="text" placeholder="服务类型" class="form-control" name="server_content" required value="<?php echo ($datainfo["server_content"]); ?>" /></div>
							<div class="input-group mt10 w12"><textarea placeholder="将服务的主要内容填写在这里" rows="5" class="form-control" name="server_text" required ></textarea></div>
