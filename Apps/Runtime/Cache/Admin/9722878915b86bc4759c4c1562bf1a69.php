...
.table tr th{
	...
	<tr>
		...
		<th width=200>寄件人地址</th> 
		<th width=100>状态</th> 
		<th width=150>取单时间</th>
		<th width=150>时间</th>
	</tr>
	<?php if(is_array($cendlist)): $i = 0; $__LIST__ = $cendlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
		<td><?php echo ($vo["cend_id"]); ?></td>
		<td><?php echo ($vo["realname"]); ?></td>
		<td><?php echo ($vo["phone"]); ?></td>
		<td><?php echo ($vo["address"]); ?></td>
		<td><?php echo ($vo["cender_address"]); ?></td>
		<td><a href="/Admin/OrderManage/change_cend_status/cid/<?php echo ($vo["cend_id"]); ?>"><?php echo ($vo["status_name"]); ?></a></td>
		<td><?php echo (date('Y-m-d H:i:s',$vo["get_time"])); ?></td>
