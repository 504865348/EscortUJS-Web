...
.table tr th{
	...
	<?php if(is_array($glists)): $i = 0; $__LIST__ = $glists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
		<td><?php echo ($vo["glist_id"]); ?></td>
		<td><?php echo ($vo["glist_phone"]); ?></td>
		<td><?php echo ($vo["glist_gids"]); ?></td>
		<td><a href="/Admin/OrderManage/group/id/<?php echo ($vo["glist_id"]); ?>">详情</a></td>
		<td><?php echo (date('Y-m-d H:i:s',$vo["glist_time"])); ?></td>
