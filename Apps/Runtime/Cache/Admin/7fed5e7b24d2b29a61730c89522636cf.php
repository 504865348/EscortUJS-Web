...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <form action="/Admin/BaseParameter/doExpCompanyUpdate" method="post">
			<div class="head">
		...
		<li><a href="/Admin/News/index" target="_self">消息设置</a></li>
				...
				<div class="article col-md-10">
						...
						<div class="w11 center-block"> 
							<div class="input-group mt10 w12"><input type="hidden" name="expcompany_id" value="<?php echo ($datainfo["expcompany_id"]); ?>" /></div>
							<div class="input-group mt10 w12"><input type="text" placeholder="快递公司" class="form-control" name="expcompany_name" required value="<?php echo ($datainfo["expcompany_name"]); ?>" /></div>
							<div class="input-group mt10 w12 mb20"><input type="submit" value="更改" class="btn w12 bcm tcw" /></div>
						</div>
